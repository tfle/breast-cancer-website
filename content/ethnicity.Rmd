...
plot <- ggplot(cancer.bcsc, aes(x = race.factor)) + 
  ...
  my_theme +
  labs(title = "Effect of Ethnicity on the Incidence of Breast Cancer", x = "Ethnicity", y = "Frequency of Breast Cancer") +
...
The incidence of breast cancer is notably larger in white women. The next highest incidence belongs to black people, Asians and then Native Americans. The highest incidence in white individuals can be attributed to the diet and lifestyle which can also lead to a high BMI in the population.