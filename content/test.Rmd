...
my_theme <- theme_classic() +
  theme(plot.background = element_rect(NULL), panel.grid = element_line(NULL))
```
...
age.incidence + geom_bar(fill = "pink", colour = "black") + labs(title = "Barplot of the Effect of Age on Incidence", x = "Age", y = "Frequency") + my_theme
```
...
age.recurrence + geom_bar(aes(fill = Class)) + labs(title = "Double Barplot of the Effect of Age on Recurrence", x = "Age", y = "Frequency") + my_theme
```
...
race.incidence + geom_bar(fill = "pink", colour = "black") + labs(title = "Effect of Race on the Incidence of Breast Cancer", x = "Race / Ethnicity", y = "Frequency") + my_theme
```
...
menopause.incidence + geom_bar(fill = "pink", colour = "black") + labs(title = "Effect of Menopause on the Incidence of Breast Cancer", y = "Frequency of Breast Cancer") + theme(axis.title.x = element_blank()) + my_theme
```
...
## Menopause mosaic plot
```{r}
bcsc2 <- subset(bcsc2, menopaus <=2)
cancer <- factor(bcsc2$cancer, labels = c("No", "Yes"))
menopause <- factor(bcsc2$menopaus, labels = c("Premenopausal", "Postmenopausual or Age >= 55"))
cancer.menopause <- table(cancer, menopause, dnn = list("Diagnosis of breast cancer", "Menopause"))
mosaic(cancer.menopause, shade = TRUE, legend = FALSE)
assoc(cancer.menopause, shade = TRUE, legend = FALSE)
```

## Datahub Dataset
```{r}
menopause.incidence <- ggplot(datahub, aes(x = factor(menopause)))
menopause.incidence + geom_bar(fill = "pink", colour = "black") + labs(title = "Barplot of the Effect of Menopause on Incidence", x = "Menopause", y = "Frequency") + my_theme
```
...
hrt.incidence + geom_bar(fill = "pink", colour = "black") + labs(title = "Barplot of the Effect of Hormone Therapy on Incidence", y = "Frequency") + theme(axis.title.x = element_blank()) + my_theme
```
...
bmi.incidence + geom_bar(fill = "pink", colour = "black") + labs(title = "Barplot of the Effect of BMI on Incidence", x = "BMI", y = "Frequency") + my_theme
```
```{r}
bmi.incidence <- ggplot(subset(bcsc2, cancer == "1" & bmi <= 4), aes(x = factor(bmi, labels = c("10-24.99", "25-29.99", "30-34.99", "35 or more"))))
bmi.incidence + geom_bar(fill = "pink", colour = "black") + labs(title = "Effect of BMI on Incidence of Breast Cancer", x = "BMI", y = "Frequency of Breast Cancer") + my_theme
```
```{r mosaic}
...
nrelbc.incidence + geom_bar(fill = "pink", colour = "black") + labs(title = "Effect of Number of First Degree Relatives on Incidence of Breast Cancer", x = "Number of first degree relatives", y = "Frequency of Positive Diagnoses") + my_theme
```
<!-- 
