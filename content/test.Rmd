...
race.incidence + geom_bar() + labs(title = "Effect of Race on the Incidence of Breast Cancer", x = "Race / Ethnicity", y = "Frequency")
```
...
menopause.incidence + geom_bar() + labs(title = "Effect of Menopause on the Incidence of Breast Cancer", y = "Frequency") + theme(axis.title.x = element_blank())
```
